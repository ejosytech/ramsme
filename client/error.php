 ...
 ?>
    ...
    <div class="rf-register-form">
            ...
            case 'image_type_err':
                    ...
                    <?php 
                    break;
            case 'image_type_err1':
                    ?> 
                    <div class="alert alert-danger"> [Register] Sorry, Image Compression Issues.,   Please click to  <?php   $url = htmlspecialchars($_SERVER['HTTP_REFERER']);  echo "<a href='$url'>Go Back</a>";  ?> </div>
                    <?php 
                    break;
            case 'pass_size_err':
                    ?> 
