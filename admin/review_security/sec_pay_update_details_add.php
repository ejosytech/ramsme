...
$condition = ' AND mobile_no LIKE "%'.$_REQUEST['mobile_no'].'%" '. ' AND pay_date between '. "'" . $_REQUEST['start_date']. "'" . ' AND '. "'" .$_REQUEST['end_date']. "'";  
 ...
 $query = "SELECT * FROM payments where service = 'security' " . $condition . "LIMIT ". $start_from . "," . $record_per_page;  
 ...
 $page_query = "SELECT * FROM payments where service = 'security'" . $condition;  
