...
$query = "SELECT * FROM pay_sec_update where service = 'security' " . $condition . "LIMIT " . $start_from . "," . $record_per_page;
...
while ($row = mysqli_fetch_array($result)) {
    $output .= '  
            <tr readonly>
                                      ...
                                      <td>' . $row['service'] .'</td>
                                      <td>' . $row['remark'] . '</td>
                                      <td>' . '<a href="sec-update.php?entry='. $row['entry'] .'" class="mr-3" title="Update Record" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>'. '</td>
                                      <td>' . '<a href="sec-delete.php?entry='. $row['entry'] .'" title="Delete Record" data-toggle="tooltip"><span class="fa fa-trash"></span></a>'. '</td>
...
$page_query = "SELECT * FROM pay_sec_update where service = 'security'" . $condition;
