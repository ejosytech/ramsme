...
<html lang="en">
 ...
 <?php
 include 'adminSecHF/header_adminSec.php';
 ?>
    
    <div id="main-wrapper" class="container justify-content-center">
   
           <h1> Update Security Records </h1>
        ...
        <div class="alert alert-success" role="alert">
         ...
         <!--------------------------------------<!-- --> 
           ...
           <div class="col-sm-12">
              ...
              <div id="viewresponseupdate_sec_reg"> 
        ...
        <!--------------------------------------<!-- Update Infrastructure Records -->
            ...
            <div class="col-sm-12">
              ...
              <div id="viewresponseupdate_sec_upd">  </div> 
...
<?php
 include 'adminSecHF/footer_adminSec.php';
 ?>
