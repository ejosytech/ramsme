    ...
    <div class="row justify-content-center">
        ...
        <div class="col-xl-10">
            <div class="card border-0">
                <div class="card-body p-0">
                 ...
                 <h1 class="my-5"> Infrastructure Payments Status Review </h1>
			...
			<div class="col-sm-12">
                ...
                <div class="col-md-12">
                    ...
                    //Capture "Page no" and store in session to be use in Print page 
                   // session_start();   // Initialize the session
                    $_SESSION["page"]= $page;                   
        ...
        <ul class="pagination">
            ...
            <p></p>
                 ...
                 <p>
                 <a href="/admin/contributn_summary/infr_estate_status_prptn.php" class="btn btn-danger ml-3">Print</a>
                 </p>
                 <p>
                 <a href="/admin/contributn_summary/excel_infr_estate_rpt.php" class="btn btn-danger ml-3">Excel</a>
                 </p>
