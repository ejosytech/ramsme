...
// Check existence of entryparameter before processing further
    if(isset($_GET["entry"]) && !empty(trim($_GET["entry"]))){
        ...
        $sql = "SELECT * FROM pay_sec_update WHERE service = 'infrastructure' and entry = ?";
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                if(mysqli_num_rows($result) == 1){
                    ...
                    header("location: infr-error.php");
                    exit();
                }
    ...
    // Check input errors before inserting in database
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                header("location: infr_pay_update.php");
                exit();
            } else{
                header("location: infr-error.php");
                exit();
        ...
        <div class="col-xl-10">
            <div class="card border-0">
                ...
                <span class="invalid-feedback"><?php echo $occupancy_err; ?></span>
                        ...
                        <a href="infr_pay_update.php" class="btn btn-primary">Back</a>
                        </div>
                    </form>
