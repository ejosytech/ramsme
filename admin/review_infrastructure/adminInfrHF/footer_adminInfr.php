          ...
          e.preventDefault();
            $.ajax({url: theURL,
                    success: function(result){
                     $("#viewresponseupdate_infr_reg").html(result);
                     }});
        });
    });
     </script>
...
<script>
 ...
 $(document).ready(function(){  
      ...
      {  
           $.ajax({  
                url:"infr_pay_update_details_add.php",  
                method:"POST",  
                data:{
                       page:page,
                    ...
                    success:function(data){  
                     $('#viewresponseupdate_infr_reg').html(data);  
                }  
           })  
      }  
      ...
      {  
          ...
          $.ajax({  
                ...
                data:{entry:entry},  
                success:function(data){  
                     $('#viewresponseupdate_infr_upd').html(data);  
                }  
           });    
      });
 });  
 ...
 $(document).ready(function(){  
      ...
      {  
           $.ajax({  
                url:"infr_pay_update_details_edit.php",  
                method:"POST",  
                data:{
                    page:page,
