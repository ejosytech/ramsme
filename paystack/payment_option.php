           ...
           <form class="row g-3 was-validated" action="initialize_live.php" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <button type="button" class="btn btn-primary align-items-lg-end" data-bs-toggle="modal" data-bs-target="#payModal">Enter an Amount</button>
                           <span class="input-group-text"> =N=</span>
                            <input id="amount" type="text" name="amount" class="form-control" title="Transaction Amount Entry Guide" data-bs-toggle="popover" data-bs-trigger="hover" data-bs-content="Click on the blue button to your left to open up the form for entry the transaction amount" aria-label="Amount (to the nearest Naira)" readonly required>
